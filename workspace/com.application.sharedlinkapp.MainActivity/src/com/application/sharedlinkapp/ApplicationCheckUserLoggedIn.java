...
//	String DBUrl="http://127.0.0.1/sharedLinksApp/fetchDataFromDbJSON.php";
...
//      		response=CustomHttpClient.executeHttpGet(DBUrl);
    ...
    public static ArrayList linksParserJSONData(String result)
    {
